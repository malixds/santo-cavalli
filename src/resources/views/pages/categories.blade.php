...
@section('content')
    ...
    <section class="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mt-20">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="group relative border border-gray-200 rounded-lg hover:shadow-md transition-all duration-300">
                <div class="p-6">
                    <h3 class="text-xl font-medium text-gray-900 mb-2 libre-baskerville-regular">Футболки</h3>
                    <p class="text-gray-500 text-sm">24 products</p>
                    <div class="mt-4">
                        <a href="/category/t-shirts" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-black transition-colors">
                            View all
                ...
                <a href="/category/t-shirts" class="absolute inset-0 z-10" aria-label="T-Shirts"></a>
            </div>
    ...
    <section class="py-16 bg-gray-50 mt-16">
        <div class="max-w-4xl mx-auto text-center px-4">
            ...
            <p class="text-gray-600 mb-8 max-w-2xl mx-auto">Our consultants will help you find exactly what you're looking for</p>
            <a href="/contact"
