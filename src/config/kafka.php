...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This file contains the configuration for Kafka messaging.
    ...
    */
    ...
    'consumer_group_id' => env('KAFKA_CONSUMER_GROUP_ID', 'laravel-app'),
    ...
    'consumers' => [
        'default' => [
            'brokers' => env('KAFKA_BROKERS', 'kafka:9092'),
            'group_id' => env('KAFKA_CONSUMER_GROUP_ID', 'laravel-app'),
