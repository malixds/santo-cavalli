 ...
 * Copyright 2024 Preline Labs Ltd.
 */
class o extends n.A{elementInput(t,e){this.onInput(t,e)}elementPaste(t){this.onPaste(t)}elementKeydown(t,e){this.onKeydown(t,e)}elementFocusin(t){this.onFocusIn(t)}elementFocusout(t){this.onFocusOut(t)}constructor(t,e){super(t,e);const i=t.getAttribute("data-pin-input"),s=i?JSON.parse(i):{},n=Object.assign(Object.assign({},s),e);this.items=this.el.querySelectorAll("[data-pin-input-item]"),this.currentItem=null,this.currentValue=new Array(this.items.length).fill(""),this.placeholders=[],this.availableCharsRE=new RegExp((null==n?void 0:n.availableCharsRE)||"^[a-zA-Z0-9]+$"),this.onElementInputListener=[],this.onElementPasteListener=[],this.onElementKeydownListener=[],this.onElementFocusinListener=[],this.onElementFocusoutListener=[],this.init()}init(){this.createCollection(window.$hsPinInputCollection,this),this.items.length&&this.build()}build(){this.buildInputItems()}buildInputItems(){this.items.forEach((t,e)=>{this.placeholders.push(t.getAttribute("placeholder")||""),t.hasAttribute("autofocus")&&this.onFocusIn(e),this.onElementInputListener.push({el:t,fn:t=>this.elementInput(t,e)}),this.onElementPasteListener.push({el:t,fn:t=>this.elementPaste(t)}),this.onElementKeydownListener.push({el:t,fn:t=>this.elementKeydown(t,e)}),this.onElementFocusinListener.push({el:t,fn:()=>this.elementFocusin(e)}),this.onElementFocusoutListener.push({el:t,fn:()=>this.elementFocusout(e)}),t.addEventListener("input",this.onElementInputListener.find(e=>e.el===t).fn),t.addEventListener("paste",this.onElementPasteListener.find(e=>e.el===t).fn),t.addEventListener("keydown",this.onElementKeydownListener.find(e=>e.el===t).fn),t.addEventListener("focusin",this.onElementFocusinListener.find(e=>e.el===t).fn),t.addEventListener("focusout",this.onElementFocusoutListener.find(e=>e.el===t).fn)})}checkIfNumber(t){return t.match(this.availableCharsRE)}autoFillAll(t){Array.from(t).forEach((t,e)=>{if(!(null==this?void 0:this.items[e]))return!1;this.items[e].value=t,this.items[e].dispatchEvent(new Event("input",{bubbles:!0}))})}setCurrentValue(){this.currentValue=Array.from(this.items).map(t=>t.value)}toggleCompleted(){this.currentValue.includes("")?this.el.classList.remove("active"):this.el.classList.add("active")}onInput(t,e){const i=t.target.value;if(this.currentItem=t.target,this.currentItem.value="",this.currentItem.value=i[i.length-1],!this.checkIfNumber(this.currentItem.value))return this.currentItem.value=this.currentValue[e]||"",!1;if(this.setCurrentValue(),this.currentItem.value){if(e<this.items.length-1&&this.items[e+1].focus(),!this.currentValue.includes("")){const t={currentValue:this.currentValue};this.fireEvent("completed",t),(0,s.JD)("completed.pinInput",this.el,t)}this.toggleCompleted()}else e>0&&this.items[e-1].focus()}onKeydown(t,e){"Backspace"===t.key&&e>0&&(""===this.items[e].value?(this.items[e-1].value="",this.items[e-1].focus()):this.items[e].value=""),this.setCurrentValue(),this.toggleCompleted()}onFocusIn(t){this.items[t].setAttribute("placeholder","")}onFocusOut(t){this.items[t].setAttribute("placeholder",this.placeholders[t])}onPaste(t){t.preventDefault(),this.items.forEach(e=>{document.activeElement===e&&this.autoFillAll(t.clipboardData.getData("text"))})}destroy(){this.el.classList.remove("active"),this.items.length&&this.items.forEach(t=>{t.removeEventListener("input",this.onElementInputListener.find(e=>e.el===t).fn),t.removeEventListener("paste",this.onElementPasteListener.find(e=>e.el===t).fn),t.removeEventListener("keydown",this.onElementKeydownListener.find(e=>e.el===t).fn),t.removeEventListener("focusin",this.onElementFocusinListener.find(e=>e.el===t).fn),t.removeEventListener("focusout",this.onElementFocusoutListener.find(e=>e.el===t).fn)}),this.items=null,this.currentItem=null,this.currentValue=null,window.$hsPinInputCollection=window.$hsPinInputCollection.filter(({element:t})=>t.el!==this.el)}static getInstance(t,e){const i=window.$hsPinInputCollection.find(e=>e.element.el===("string"==typeof t?document.querySelector(t):t));return i?e?i:i.element:null}static autoInit(){window.$hsPinInputCollection||(window.$hsPinInputCollection=[]),window.$hsPinInputCollection&&(window.$hsPinInputCollection=window.$hsPinInputCollection.filter(({element:t})=>document.contains(t.el))),document.querySelectorAll("[data-pin-input]:not(.--prevent-on-load-init)").forEach(t=>{window.$hsPinInputCollection.find(e=>{var i;return(null===(i=null==e?void 0:e.element)||void 0===i?void 0:i.el)===t})||new o(t)})}}window.addEventListener("load",()=>{o.autoInit()}),"undefined"!=typeof window&&(window.HSPinInput=o);const l=o},663:(t,e,i)=>{i.d(e,{ll:()=>Ct,rD:()=>It,UU:()=>Lt,cY:()=>bt,BN:()=>St});const s=Math.min,n=Math.max,o=Math.round,l=Math.floor,r=t=>({x:t,y:t}),a={left:"right",right:"left",bottom:"top",top:"bottom"},c={start:"end",end:"start"};function h(t,e,i){return n(t,s(e,i))}function d(t,e){return"function"==typeof t?t(e):t}function u(t){return t.split("-")[0]}function p(t){return t.split("-")[1]}function m(t){return"x"===t?"y":"x"}function g(t){return"y"===t?"height":"width"}const v=new Set(["top","bottom"]);function f(t){return v.has(u(t))?"y":"x"}function w(t){return m(f(t))}function y(t){return t.replace(/start|end/g,t=>c[t])}const C=["left","right"],b=["right","left"],S=["top","bottom"],L=["bottom","top"];function I(t,e,i,s){const n=p(t);let o=function(t,e,i){switch(t){case"top":case"bottom":return i?e?b:C:e?C:b;case"left":case"right":return e?S:L;default:return[]}}(u(t),"start"===i,s);return n&&(o=o.map(t=>t+"-"+n),e&&(o=o.concat(o.map(y)))),o}function x(t){return t.replace(/left|right|bottom|top/g,t=>a[t])}function E(t){const{x:e,y:i,width:s,height:n}=t;return{width:s,height:n,top:i,left:e,right:e+s,bottom:i+n,x:e,y:i}}function T(t,e,i){let{reference:s,floating:n}=t;const o=f(e),l=w(e),r=g(l),a=u(e),c="y"===o,h=s.x+s.width/2-n.width/2,d=s.y+s.height/2-n.height/2,m=s[r]/2-n[r]/2;let v;switch(a){case"top":v={x:h,y:s.y-n.height};break;case"bottom":v={x:h,y:s.y+s.height};break;case"right":v={x:s.x+s.width,y:d};break;case"left":v={x:s.x-n.width,y:d};break;default:v={x:s.x,y:s.y}}switch(p(e)){case"start":v[l]-=m*(i&&c?-1:1);break;case"end":v[l]+=m*(i&&c?-1:1)}return v}async function k(t,e){var i;void 0===e&&(e={});const{x:s,y:n,platform:o,rects:l,elements:r,strategy:a}=t,{boundary:c="clippingAncestors",rootBoundary:h="viewport",elementContext:u="floating",altBoundary:p=!1,padding:m=0}=d(e,t),g=function(t){return"number"!=typeof t?function(t){return{top:0,right:0,bottom:0,left:0,...t}}(t):{top:t,right:t,bottom:t,left:t}}(m),v=r[p?"floating"===u?"reference":"floating":u],f=E(await o.getClippingRect({element:null==(i=await(null==o.isElement?void 0:o.isElement(v)))||i?v:v.contextElement||await(null==o.getDocumentElement?void 0:o.getDocumentElement(r.floating)),boundary:c,rootBoundary:h,strategy:a})),w="floating"===u?{x:s,y:n,width:l.floating.width,height:l.floating.height}:l.reference,y=await(null==o.getOffsetParent?void 0:o.getOffsetParent(r.floating)),C=await(null==o.isElement?void 0:o.isElement(y))&&await(null==o.getScale?void 0:o.getScale(y))||{x:1,y:1},b=E(o.convertOffsetParentRelativeRectToViewportRelativeRect?await o.convertOffsetParentRelativeRectToViewportRelativeRect({elements:r,rect:w,offsetParent:y,strategy:a}):w);return{top:(f.top-b.top+g.top)/C.y,bottom:(b.bottom-f.bottom+g.bottom)/C.y,left:(f.left-b.left+g.left)/C.x,right:(b.right-f.right+g.right)/C.x}}const A=new Set(["left","top"]);function $(){return"undefined"!=typeof window}function O(t){return B(t)?(t.nodeName||"").toLowerCase():"#document"}function P(t){var e;return(null==t||null==(e=t.ownerDocument)?void 0:e.defaultView)||window}function D(t){var e;return null==(e=(B(t)?t.ownerDocument:t.document)||window.document)?void 0:e.documentElement}function B(t){return!!$()&&(t instanceof Node||t instanceof P(t).Node)}function q(t){return!!$()&&(t instanceof Element||t instanceof P(t).Element)}function M(t){return!!$()&&(t instanceof HTMLElement||t instanceof P(t).HTMLElement)}function N(t){return!(!$()||"undefined"==typeof ShadowRoot)&&(t instanceof ShadowRoot||t instanceof P(t).ShadowRoot)}const F=new Set(["inline","contents"]);function R(t){const{overflow:e,overflowX:i,overflowY:s,display:n}=G(t);return/auto|scroll|overlay|hidden|clip/.test(e+s+i)&&!F.has(n)}const H=new Set(["table","td","th"]);function V(t){return H.has(O(t))}const U=[":popover-open",":modal"];function W(t){return U.some(e=>{try{return t.matches(e)}catch(t){return!1}})}const j=["transform","translate","scale","rotate","perspective"],z=["transform","translate","scale","rotate","perspective","filter"],J=["paint","layout","strict","content"];function Q(t){const e=Z(),i=q(t)?G(t):t;return j.some(t=>!!i[t]&&"none"!==i[t])||!!i.containerType&&"normal"!==i.containerType||!e&&!!i.backdropFilter&&"none"!==i.backdropFilter||!e&&!!i.filter&&"none"!==i.filter||z.some(t=>(i.willChange||"").includes(t))||J.some(t=>(i.contain||"").includes(t))}function Z(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}const K=new Set(["html","body","#document"]);function X(t){return K.has(O(t))}function G(t){return P(t).getComputedStyle(t)}function _(t){return q(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function Y(t){if("html"===O(t))return t;const e=t.assignedSlot||t.parentNode||N(t)&&t.host||D(t);return N(e)?e.host:e}function tt(t){const e=Y(t);return X(e)?t.ownerDocument?t.ownerDocument.body:t.body:M(e)&&R(e)?e:tt(e)}function et(t,e,i){var s;void 0===e&&(e=[]),void 0===i&&(i=!0);const n=tt(t),o=n===(null==(s=t.ownerDocument)?void 0:s.body),l=P(n);if(o){const t=it(l);return e.concat(l,l.visualViewport||[],R(n)?n:[],t&&i?et(t):[])}return e.concat(n,et(n,[],i))}function it(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function st(t){const e=G(t);let i=parseFloat(e.width)||0,s=parseFloat(e.height)||0;const n=M(t),l=n?t.offsetWidth:i,r=n?t.offsetHeight:s,a=o(i)!==l||o(s)!==r;return a&&(i=l,s=r),{width:i,height:s,$:a}}function nt(t){return q(t)?t:t.contextElement}function ot(t){const e=nt(t);if(!M(e))return r(1);const i=e.getBoundingClientRect(),{width:s,height:n,$:l}=st(e);let a=(l?o(i.width):i.width)/s,c=(l?o(i.height):i.height)/n;return a&&Number.isFinite(a)||(a=1),c&&Number.isFinite(c)||(c=1),{x:a,y:c}}const lt=r(0);function rt(t){const e=P(t);return Z()&&e.visualViewport?{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}:lt}function at(t,e,i,s){void 0===e&&(e=!1),void 0===i&&(i=!1);const n=t.getBoundingClientRect(),o=nt(t);let l=r(1);e&&(s?q(s)&&(l=ot(s)):l=ot(t));const a=function(t,e,i){return void 0===e&&(e=!1),!(!i||e&&i!==P(t))&&e}(o,i,s)?rt(o):r(0);let c=(n.left+a.x)/l.x,h=(n.top+a.y)/l.y,d=n.width/l.x,u=n.height/l.y;if(o){const t=P(o),e=s&&q(s)?P(s):s;let i=t,n=it(i);for(;n&&s&&e!==i;){const t=ot(n),e=n.getBoundingClientRect(),s=G(n),o=e.left+(n.clientLeft+parseFloat(s.paddingLeft))*t.x,l=e.top+(n.clientTop+parseFloat(s.paddingTop))*t.y;c*=t.x,h*=t.y,d*=t.x,u*=t.y,c+=o,h+=l,i=P(n),n=it(i)}}return E({width:d,height:u,x:c,y:h})}function ct(t,e){const i=_(t).scrollLeft;return e?e.left+i:at(D(t)).left+i}function ht(t,e,i){void 0===i&&(i=!1);const s=t.getBoundingClientRect();return{x:s.left+e.scrollLeft-(i?0:ct(t,s)),y:s.top+e.scrollTop}}const dt=new Set(["absolute","fixed"]);function ut(t,e,i){let s;if("viewport"===e)s=function(t,e){const i=P(t),s=D(t),n=i.visualViewport;let o=s.clientWidth,l=s.clientHeight,r=0,a=0;if(n){o=n.width,l=n.height;const t=Z();(!t||t&&"fixed"===e)&&(r=n.offsetLeft,a=n.offsetTop)}return{width:o,height:l,x:r,y:a}}(t,i);else if("document"===e)s=function(t){const e=D(t),i=_(t),s=t.ownerDocument.body,o=n(e.scrollWidth,e.clientWidth,s.scrollWidth,s.clientWidth),l=n(e.scrollHeight,e.clientHeight,s.scrollHeight,s.clientHeight);let r=-i.scrollLeft+ct(t);const a=-i.scrollTop;return"rtl"===G(s).direction&&(r+=n(e.clientWidth,s.clientWidth)-o),{width:o,height:l,x:r,y:a}}(D(t));else if(q(e))s=function(t,e){const i=at(t,!0,"fixed"===e),s=i.top+t.clientTop,n=i.left+t.clientLeft,o=M(t)?ot(t):r(1);return{width:t.clientWidth*o.x,height:t.clientHeight*o.y,x:n*o.x,y:s*o.y}}(e,i);else{const i=rt(t);s={x:e.x-i.x,y:e.y-i.y,width:e.width,height:e.height}}return E(s)}function pt(t,e){const i=Y(t);return!(i===e||!q(i)||X(i))&&("fixed"===G(i).position||pt(i,e))}function mt(t,e,i){const s=M(e),n=D(e),o="fixed"===i,l=at(t,!0,o,e);let a={scrollLeft:0,scrollTop:0};const c=r(0);function h(){c.x=ct(n)}if(s||!s&&!o)if(("body"!==O(e)||R(n))&&(a=_(e)),s){const t=at(e,!0,o,e);c.x=t.x+e.clientLeft,c.y=t.y+e.clientTop}else n&&h();o&&!s&&n&&h();const d=!n||s||o?r(0):ht(n,a);return{x:l.left+a.scrollLeft-c.x-d.x,y:l.top+a.scrollTop-c.y-d.y,width:l.width,height:l.height}}function gt(t){return"static"===G(t).position}function vt(t,e){if(!M(t)||"fixed"===G(t).position)return null;if(e)return e(t);let i=t.offsetParent;return D(t)===i&&(i=i.ownerDocument.body),i}function ft(t,e){const i=P(t);if(W(t))return i;if(!M(t)){let e=Y(t);for(;e&&!X(e);){if(q(e)&&!gt(e))return e;e=Y(e)}return i}let s=vt(t,e);for(;s&&V(s)&&gt(s);)s=vt(s,e);return s&&X(s)&&gt(s)&&!Q(s)?i:s||function(t){let e=Y(t);for(;M(e)&&!X(e);){if(Q(e))return e;if(W(e))return null;e=Y(e)}return null}(t)||i}const wt={convertOffsetParentRelativeRectToViewportRelativeRect:function(t){let{elements:e,rect:i,offsetParent:s,strategy:n}=t;const o="fixed"===n,l=D(s),a=!!e&&W(e.floating);if(s===l||a&&o)return i;let c={scrollLeft:0,scrollTop:0},h=r(1);const d=r(0),u=M(s);if((u||!u&&!o)&&(("body"!==O(s)||R(l))&&(c=_(s)),M(s))){const t=at(s);h=ot(s),d.x=t.x+s.clientLeft,d.y=t.y+s.clientTop}const p=!l||u||o?r(0):ht(l,c,!0);return{width:i.width*h.x,height:i.height*h.y,x:i.x*h.x-c.scrollLeft*h.x+d.x+p.x,y:i.y*h.y-c.scrollTop*h.y+d.y+p.y}},getDocumentElement:D,getClippingRect:function(t){let{element:e,boundary:i,rootBoundary:o,strategy:l}=t;const r=[..."clippingAncestors"===i?W(e)?[]:function(t,e){const i=e.get(t);if(i)return i;let s=et(t,[],!1).filter(t=>q(t)&&"body"!==O(t)),n=null;const o="fixed"===G(t).position;let l=o?Y(t):t;for(;q(l)&&!X(l);){const e=G(l),i=Q(l);i||"fixed"!==e.position||(n=null),(o?!i&&!n:!i&&"static"===e.position&&n&&dt.has(n.position)||R(l)&&!i&&pt(t,l))?s=s.filter(t=>t!==l):n=e,l=Y(l)}return e.set(t,s),s}(e,this._c):[].concat(i),o],a=r[0],c=r.reduce((t,i)=>{const o=ut(e,i,l);return t.top=n(o.top,t.top),t.right=s(o.right,t.right),t.bottom=s(o.bottom,t.bottom),t.left=n(o.left,t.left),t},ut(e,a,l));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}},getOffsetParent:ft,getElementRects:async function(t){const e=this.getOffsetParent||ft,i=this.getDimensions,s=await i(t.floating);return{reference:mt(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:s.width,height:s.height}}},getClientRects:function(t){return Array.from(t.getClientRects())},getDimensions:function(t){const{width:e,height:i}=st(t);return{width:e,height:i}},getScale:ot,isElement:q,isRTL:function(t){return"rtl"===G(t).direction}};function yt(t,e){return t.x===e.x&&t.y===e.y&&t.width===e.width&&t.height===e.height}function Ct(t,e,i,o){void 0===o&&(o={});const{ancestorScroll:r=!0,ancestorResize:a=!0,elementResize:c="function"==typeof ResizeObserver,layoutShift:h="function"==typeof IntersectionObserver,animationFrame:d=!1}=o,u=nt(t),p=r||a?[...u?et(u):[],...et(e)]:[];p.forEach(t=>{r&&t.addEventListener("scroll",i,{passive:!0}),a&&t.addEventListener("resize",i)});const m=u&&h?function(t,e){let i,o=null;const r=D(t);function a(){var t;clearTimeout(i),null==(t=o)||t.disconnect(),o=null}return function c(h,d){void 0===h&&(h=!1),void 0===d&&(d=1),a();const u=t.getBoundingClientRect(),{left:p,top:m,width:g,height:v}=u;if(h||e(),!g||!v)return;const f={rootMargin:-l(m)+"px "+-l(r.clientWidth-(p+g))+"px "+-l(r.clientHeight-(m+v))+"px "+-l(p)+"px",threshold:n(0,s(1,d))||1};let w=!0;function y(e){const s=e[0].intersectionRatio;if(s!==d){if(!w)return c();s?c(!1,s):i=setTimeout(()=>{c(!1,1e-7)},1e3)}1!==s||yt(u,t.getBoundingClientRect())||c(),w=!1}try{o=new IntersectionObserver(y,{...f,root:r.ownerDocument})}catch(t){o=new IntersectionObserver(y,f)}o.observe(t)}(!0),a}(u,i):null;let g,v=-1,f=null;c&&(f=new ResizeObserver(t=>{let[s]=t;s&&s.target===u&&f&&(f.unobserve(e),cancelAnimationFrame(v),v=requestAnimationFrame(()=>{var t;null==(t=f)||t.observe(e)})),i()}),u&&!d&&f.observe(u),f.observe(e));let w=d?at(t):null;return d&&function e(){const s=at(t);w&&!yt(w,s)&&i();w=s,g=requestAnimationFrame(e)}(),i(),()=>{var t;p.forEach(t=>{r&&t.removeEventListener("scroll",i),a&&t.removeEventListener("resize",i)}),null==m||m(),null==(t=f)||t.disconnect(),f=null,d&&cancelAnimationFrame(g)}}const bt=function(t){return void 0===t&&(t=0),{name:"offset",options:t,async fn(e){var i,s;const{x:n,y:o,placement:l,middlewareData:r}=e,a=await async function(t,e){const{placement:i,platform:s,elements:n}=t,o=await(null==s.isRTL?void 0:s.isRTL(n.floating)),l=u(i),r=p(i),a="y"===f(i),c=A.has(l)?-1:1,h=o&&a?-1:1,m=d(e,t);let{mainAxis:g,crossAxis:v,alignmentAxis:w}="number"==typeof m?{mainAxis:m,crossAxis:0,alignmentAxis:null}:{mainAxis:m.mainAxis||0,crossAxis:m.crossAxis||0,alignmentAxis:m.alignmentAxis};return r&&"number"==typeof w&&(v="end"===r?-1*w:w),a?{x:v*h,y:g*c}:{x:g*c,y:v*h}}(e,t);return l===(null==(i=r.offset)?void 0:i.placement)&&null!=(s=r.arrow)&&s.alignmentOffset?{}:{x:n+a.x,y:o+a.y,data:{...a,placement:l}}}}},St=function(t){return void 0===t&&(t={}),{name:"shift",options:t,async fn(e){const{x:i,y:s,placement:n}=e,{mainAxis:o=!0,crossAxis:l=!1,limiter:r={fn:t=>{let{x:e,y:i}=t;return{x:e,y:i}}},...a}=d(t,e),c={x:i,y:s},p=await k(e,a),g=f(u(n)),v=m(g);let w=c[v],y=c[g];if(o){const t="y"===v?"bottom":"right";w=h(w+p["y"===v?"top":"left"],w,w-p[t])}if(l){const t="y"===g?"bottom":"right";y=h(y+p["y"===g?"top":"left"],y,y-p[t])}const C=r.fn({...e,[v]:w,[g]:y});return{...C,data:{x:C.x-i,y:C.y-s,enabled:{[v]:o,[g]:l}}}}}},Lt=function(t){return void 0===t&&(t={}),{name:"flip",options:t,async fn(e){var i,s;const{placement:n,middlewareData:o,rects:l,initialPlacement:r,platform:a,elements:c}=e,{mainAxis:h=!0,crossAxis:m=!0,fallbackPlacements:v,fallbackStrategy:C="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:S=!0,...L}=d(t,e);if(null!=(i=o.arrow)&&i.alignmentOffset)return{};const E=u(n),T=f(r),A=u(r)===r,$=await(null==a.isRTL?void 0:a.isRTL(c.floating)),O=v||(A||!S?[x(r)]:function(t){const e=x(t);return[y(t),e,y(e)]}(r)),P="none"!==b;!v&&P&&O.push(...I(r,S,b,$));const D=[r,...O],B=await k(e,L),q=[];let M=(null==(s=o.flip)?void 0:s.overflows)||[];if(h&&q.push(B[E]),m){const t=function(t,e,i){void 0===i&&(i=!1);const s=p(t),n=w(t),o=g(n);let l="x"===n?s===(i?"end":"start")?"right":"left":"start"===s?"bottom":"top";return e.reference[o]>e.floating[o]&&(l=x(l)),[l,x(l)]}(n,l,$);q.push(B[t[0]],B[t[1]])}if(M=[...M,{placement:n,overflows:q}],!q.every(t=>t<=0)){var N,F;const t=((null==(N=o.flip)?void 0:N.index)||0)+1,e=D[t];if(e){if(!("alignment"===m&&T!==f(e))||M.every(t=>t.overflows[0]>0&&f(t.placement)===T))return{data:{index:t,overflows:M},reset:{placement:e}}}let i=null==(F=M.filter(t=>t.overflows[0]<=0).sort((t,e)=>t.overflows[1]-e.overflows[1])[0])?void 0:F.placement;if(!i)switch(C){case"bestFit":{var R;const t=null==(R=M.filter(t=>{if(P){const e=f(t.placement);return e===T||"y"===e}return!0}).map(t=>[t.placement,t.overflows.filter(t=>t>0).reduce((t,e)=>t+e,0)]).sort((t,e)=>t[1]-e[1])[0])?void 0:R[0];t&&(i=t);break}case"initialPlacement":i=r}if(n!==i)return{reset:{placement:i}}}return{}}}},It=(t,e,i)=>{const s=new Map,n={platform:wt,...i},o={...n.platform,_c:s};return(async(t,e,i)=>{const{placement:s="bottom",strategy:n="absolute",middleware:o=[],platform:l}=i,r=o.filter(Boolean),a=await(null==l.isRTL?void 0:l.isRTL(e));let c=await l.getElementRects({reference:t,floating:e,strategy:n}),{x:h,y:d}=T(c,s,a),u=s,p={},m=0;for(let i=0;i<r.length;i++){const{name:o,fn:g}=r[i],{x:v,y:f,data:w,reset:y}=await g({x:h,y:d,initialPlacement:s,placement:u,strategy:n,middlewareData:p,rects:c,platform:l,elements:{reference:t,floating:e}});h=null!=v?v:h,d=null!=f?f:d,p={...p,[o]:{...p[o],...w}},y&&m<=50&&(m++,"object"==typeof y&&(y.placement&&(u=y.placement),y.rects&&(c=!0===y.rects?await l.getElementRects({reference:t,floating:e,strategy:n}):y.rects),({x:h,y:d}=T(c,u,a))),i=-1)}return{x:h,y:d,placement:u,strategy:n,middlewareData:p}})(t,e,{...n,platform:o})}},680:(t,e,i)=>{i.d(e,{A:()=>o});var s=i(709);
/*
 * HSToggleCount
 * @version: 3.1.0
 * @author: Preline Labs Ltd.
 ...
 * Copyright 2024 Preline Labs Ltd.
 */
let L,I,x;if("undefined"!=typeof window){try{"undefined"!=typeof DataTable&&"undefined"!=typeof jQuery&&(L=i(66).A)}catch(t){console.warn("HSDataTable: Required dependencies not found"),L=null}try{"undefined"!=typeof _&&"undefined"!=typeof Dropzone&&(I=i(230).A)}catch(t){console.warn("HSFileUpload: Required dependencies not found"),I=null}try{"undefined"!=typeof noUiSlider&&(x=i(991).A)}catch(t){console.warn("HSRangeSlider: Required dependencies not found"),x=null}}const E=[{key:"copy-markup",fn:s.A,collection:"$hsCopyMarkupCollection"},{key:"accordion",fn:n.A,collection:"$hsAccordionCollection"},{key:"carousel",fn:o.A,collection:"$hsCarouselCollection"},{key:"collapse",fn:l.A,collection:"$hsCollapseCollection"},{key:"combobox",fn:r.A,collection:"$hsComboBoxCollection"},...L?[{key:"datatable",fn:L,collection:"$hsDataTableCollection"}]:[],{key:"dropdown",fn:a.A,collection:"$hsDropdownCollection"},...I?[{key:"file-upload",fn:I,collection:"$hsFileUploadCollection"}]:[],{key:"input-number",fn:c.A,collection:"$hsInputNumberCollection"},{key:"overlay",fn:h.A,collection:"$hsOverlayCollection"},{key:"pin-input",fn:d.A,collection:"$hsPinInputCollection"},...x?[{key:"range-slider",fn:x,collection:"$hsRangeSliderCollection"}]:[],{key:"remove-element",fn:u.A,collection:"$hsRemoveElementCollection"},{key:"scrollspy",fn:p.A,collection:"$hsScrollspyCollection"},{key:"select",fn:m.A,collection:"$hsSelectCollection"},{key:"stepper",fn:g.A,collection:"$hsStepperCollection"},{key:"strong-password",fn:v.A,collection:"$hsStrongPasswordCollection"},{key:"tabs",fn:f.A,collection:"$hsTabsCollection"},{key:"toggle-count",fn:w.A,collection:"$hsToggleCountCollection"},{key:"toggle-password",fn:y.A,collection:"$hsTogglePasswordCollection"},{key:"tooltip",fn:C.A,collection:"$hsTooltipCollection"},{key:"tree-view",fn:b.A,collection:"$hsTreeViewCollection"}],T={getClassProperty:S.gj,afterTransition:S.yd,autoInit(t="all"){"all"===t?E.forEach(({fn:t})=>{null==t||t.autoInit()}):E.forEach(({key:e,fn:i})=>{t.includes(e)&&(null==i||i.autoInit())})},cleanCollection(t="all"){"all"===t?E.forEach(({collection:t})=>{window[t]instanceof Array&&(window[t]=[])}):E.forEach(({key:e,collection:i})=>{t.includes(e)&&window[i]instanceof Array&&(window[i]=[])})}};"undefined"!=typeof window&&(window.HSStaticMethods=T);const k=T;
/*
 * @version: 3.1.0
 * @author: Preline Labs Ltd.
 * @license: Licensed under MIT and Preline UI Fair Use License (https://preline.co/docs/license.html)
 * Copyright 2024 Preline Labs Ltd.
 */
let A,$,O;if("undefined"!=typeof window){try{"undefined"!=typeof DataTable&&"undefined"!=typeof jQuery&&(A=i(66).A)}catch(t){console.warn("HSDataTable: Required dependencies not found"),A=null}try{"undefined"!=typeof _&&"undefined"!=typeof Dropzone&&($=i(230).A)}catch(t){console.warn("HSFileUpload: Required dependencies not found"),$=null}try{"undefined"!=typeof noUiSlider&&(O=i(991).A)}catch(t){console.warn("HSRangeSlider: Required dependencies not found"),O=null}}export{A as HSDataTable,$ as HSFileUpload,O as HSRangeSlider,k as HSStaticMethods};export const HSAccordion=n.A;export const HSCarousel=o.A;export const HSCollapse=l.A;export const HSComboBox=r.A;export const HSCopyMarkup=s.A;export const HSDropdown=a.A;export const HSInputNumber=c.A;export const HSOverlay=h.A;export const HSPinInput=d.A;export const HSRemoveElement=u.A;export const HSScrollspy=p.A;export const HSSelect=m.A;export const HSStepper=g.A;export const HSStrongPassword=v.A;export const HSTabs=f.A;export const HSToggleCount=w.A;export const HSTogglePassword=y.A;export const HSTooltip=C.A;export const HSTreeView=b.A;